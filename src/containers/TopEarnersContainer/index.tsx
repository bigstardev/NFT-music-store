...
export const TopEarnersContainer: React.FC<ITopEarnersContainer> = ({
  ...
  return (
    ...
    >
      <ScreenHeader
        goBack={() => router.push('/')}
        screenTitle="Top earners this week"
      ...
      <Styled.Body p="0 32px 32px" direction="column">
        <TopEarnersTable library={LIBRARY} />
      </Styled.Body>
    </Styled.Container>
  );
};
